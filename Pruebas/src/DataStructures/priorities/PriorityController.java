...
public class PriorityController extends Controller {
	...
	public PriorityController(Digraph graph, int numberOfProcessors) {
		...
		for (int i = 0 ; i < numberOfProcessors ; i++)
			this.workStealingController.addProcessor(new PriorityProcessor(this.multithreadedComputation,i));
